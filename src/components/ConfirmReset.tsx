      ...
      >
        ...
        <div className="flex z-20 items-center justify-center min-h-screen">
          <div className="relative mx-3 bg-white rounded-lg w-full max-w-xl md:mx-auto p-6 flex flex-col space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold text-center">¿Seguro quieres reiniciar?</h2>
            <div className="flex justify-center gap-3">
              <button
                id="closeModal"
                onClick={handleReset}
                className="bg-[#D04848] hover:bg-[#ac3b3b] text-white transition-all border font-bold py-2 px-4 rounded-md"
              >
                Reiniciar
              </button>
              <button
                ...
                className="bg-white hover:bg-neutral-100 transition-all border text-black font-bold py-2 px-4 rounded-md"
              >
                Cancelar
              </button>
            </div>
